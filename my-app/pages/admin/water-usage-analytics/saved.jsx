...
export default function TotalMoneySaved() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/admin/total-money-saved-over-time")
      ...
      .catch((error) => console.error("Error fetching total money saved over time data:", error));
  }, []);

  useEffect(() => {
    fetch("http://localhost:5000/api/admin/top-users-with-most-saved-money")
      .then((response) => response.json())
      .then((data) => setTopUsers(data))
      .catch((error) => console.error("Error fetching top users with most saved money:", error));
  }, []);
        ...
        <div className="flex flex-wrap mb-6">
          ...
          <div className="w-full lg:w-1/3 p-4">
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold mb-4">Top 10 Users with Most Saved Money</h2>
