    ...
    const fetchStats = async () => {
      try {
        const responses = await Promise.all([
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/total-woins"
          ),
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/total-relics"
          ),
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/total-potions"
          ),
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/player-inventory"
          ),
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/inventory-stats"
          ),
          fetch(
            "https://aqua-quest-backend-deployment.onrender.com/api/admin/woins-distribution"
          ),
        ]);
